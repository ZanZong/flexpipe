...
class ImageTextPairDataset(Dataset):
    ...
    def __init__(self, cfg, stage, ann_file, image_set, root_path, data_path, s3_path,
        ...
        self.random_caption = False # random_caption
    ...
    def __getitem__(self, index):
        ...
        for i_try in range(100):
            try:
                ...
                print(
                    "Failed to load image from idb {} with error {} ; trial {}; dataset_name={}".format(
                        self.database[index], e, i_try, self.dataset_name
                    )
                )
